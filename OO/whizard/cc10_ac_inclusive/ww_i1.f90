...
!
!   /cvmfs/sw-nightlies.hsf.org/key4hep/releases/2026-02-05/x86_64-almalinux9-gcc14.2.0-opt/whizard/3.1.5-b77est/bin/omega_SM_ac.opt -o ww_i1.f90 -target:whizard -target:parameter_module parameters_SM_ac -target:module opr_ww_i1 -target:md5sum B39EDFDCC15C04605F0171DF2AD67E72 -target:openmp -fusion:progress -scatter "e- e+ -> mu-:mu+ numu:numubar u:ubar d:dbar"
!
! with all scattering amplitudes for the process(es)
!
!   flavor combinations:
!
!       1: e- e+ -> mu+ numu ubar d
!       2: e- e+ -> mu- numubar u dbar
!
!   color flows:
!
...
module opr_ww_i1_computation
  ...
  data table_flavor_states(:,   1) /  11, -11, -13,  14,  -2,   1 / ! e- e+ mu+ numu ubar d
  data table_flavor_states(:,   2) /  11, -11,  13, -14,   2,  -1 / ! e- e+ mu- numubar u dbar
  ...
  data co_flv_col_is_allowed(:,   2,   1) / F /
  data co_flv_col_is_allowed(:,   1,   2) / F /
  data co_flv_col_is_allowed(:,   2,   2) / T /
  ...
  type thread_local_data
    type(spinor) :: owf_fd1_i1_p6, owf_fu1_i1_p5, owf_fn2_p4, owf_fl2_p3, &
      owf_fl1_p1
    type(conjspinor) :: owf_fd1b_o1_p6, owf_fu1b_o1_p5, owf_fn2b_p4, &
      owf_fl1b_p2, owf_fl2b_p3
    type(spinor) :: owf_fd1_i1_p126, owf_fu1_i1_p125, owf_fn2_p124, &
      owf_fn1_p156, owf_fn1_p134, owf_fl2_p123
    type(conjspinor) :: owf_fd1b_o1_p126, owf_fu1b_o1_p125, owf_fn2b_p124, &
      owf_fl2b_p123
    type(vector) :: owf_fa_p12, owf_fz_p12, owf_fwm_p56, owf_fwm_p34, &
      owf_fwp_p56, owf_fwp_p34
    complex(kind=default) :: oks_fl1_fl1b_fl2b_fn2_fu1b_o1_fd1_i1, &
      oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1
...
contains
  ...
  pure function md5sum ()
    ...
    md5sum = "B39EDFDCC15C04605F0171DF2AD67E72"
  end function md5sum
...
!$OMP PARALLEL DO DEFAULT(SHARED) PRIVATE(s, h, tld) SCHEDULE(STATIC)
    do hi = 1, hel_finite
      ...
      tld%owf_fl2_p3 = v (mass(13), p3, s(3))
      tld%owf_fn2b_p4 = ubar (mass(14), p4, s(4))
      ...
      amp(1,1,1,h) = tld%oks_fl1_fl1b_fl2b_fn2_fu1b_o1_fd1_i1
      amp(1,2,2,h) = tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1
    end do
!$OMP END PARALLEL DO
  ...
  type(thread_local_data), intent(inout) :: tld
      ...
      tld%owf_fwm_p34 = &
         ...
         + vl_ff(gcc,tld%owf_fn2b_p4,tld%owf_fl2_p3))
      tld%owf_fwp_p56 = &
         pr_unitarity(p56,mass(24),wd_tl(p56,width(24)),.false., &
         + vl_ff(gcc,tld%owf_fd1b_o1_p6,tld%owf_fu1_i1_p5))
      tld%owf_fl2_p123 = pr_psi(p123,mass(13),wd_tl(p123,width(13)),.false., &
         - f_vf(qlep,tld%owf_fa_p12,tld%owf_fl2_p3) &
         - f_vaf(gnclep(1),gnclep(2),tld%owf_fz_p12,tld%owf_fl2_p3))
      tld%owf_fn2b_p124 = &
         pr_psibar(p124,mass(14),wd_tl(p124,width(14)),.false., &
         - f_fva(gncneu(1),gncneu(2),tld%owf_fn2b_p4,tld%owf_fz_p12))
      ...
      tld%owf_fwp_p34 = &
         pr_unitarity(p34,mass(24),wd_tl(p34,width(24)),.false., &
         + vl_ff(gcc,tld%owf_fl2b_p3,tld%owf_fn2_p4))
  ...
  type(thread_local_data), intent(inout) :: tld
      ...
      tld%owf_fl2b_p123 = &
         pr_psibar(p123,mass(13),wd_tl(p123,width(13)),.false., &
         - f_fv(qlep,tld%owf_fl2b_p3,tld%owf_fa_p12) &
         - f_fva(gnclep(1),gnclep(2),tld%owf_fl2b_p3,tld%owf_fz_p12))
      tld%owf_fn2_p124 = pr_psi(p124,mass(14),wd_tl(p124,width(14)),.false., &
         - f_vaf(gncneu(1),gncneu(2),tld%owf_fz_p12,tld%owf_fn2_p4))
  ...
  type(thread_local_data), intent(inout) :: tld
      tld%oks_fl1_fl1b_fl2b_fn2_fu1b_o1_fd1_i1 = 0
      tld%oks_fl1_fl1b_fl2b_fn2_fu1b_o1_fd1_i1 = &
        tld%oks_fl1_fl1b_fl2b_fn2_fu1b_o1_fd1_i1 + ( &
         - f_fvl(gcc,tld%owf_fn2b_p4,tld%owf_fwp_p56))*tld%owf_fl2_p123
      tld%oks_fl1_fl1b_fl2b_fn2_fu1b_o1_fd1_i1 = &
        tld%oks_fl1_fl1b_fl2b_fn2_fu1b_o1_fd1_i1 + tld%owf_fn2b_p124*( &
         - f_vlf(gcc,tld%owf_fwp_p56,tld%owf_fl2_p3))
      tld%oks_fl1_fl1b_fl2b_fn2_fu1b_o1_fd1_i1 = &
        tld%oks_fl1_fl1b_fl2b_fn2_fu1b_o1_fd1_i1 + ( &
      ...
      tld%oks_fl1_fl1b_fl2b_fn2_fu1b_o1_fd1_i1 = &
        tld%oks_fl1_fl1b_fl2b_fn2_fu1b_o1_fd1_i1 + tld%owf_fd1b_o1_p126*( &
         - f_vlf(gcc,tld%owf_fwm_p34,tld%owf_fu1_i1_p5))
      tld%oks_fl1_fl1b_fl2b_fn2_fu1b_o1_fd1_i1 = &
        tld%oks_fl1_fl1b_fl2b_fn2_fu1b_o1_fd1_i1 + tld%owf_fa_p12*( &
      ...
      tld%oks_fl1_fl1b_fl2b_fn2_fu1b_o1_fd1_i1 = &
        tld%oks_fl1_fl1b_fl2b_fn2_fu1b_o1_fd1_i1 + tld%owf_fz_p12*( &
      ...
      tld%oks_fl1_fl1b_fl2b_fn2_fu1b_o1_fd1_i1 = &
         - tld%oks_fl1_fl1b_fl2b_fn2_fu1b_o1_fd1_i1 ! 4 vertices, 3 propagators
      ! unit symmetry factor
  end subroutine compute_brakets_0001
  subroutine compute_brakets_0002 (tld)
  type(thread_local_data), intent(inout) :: tld
      tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1 = 0
      tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1 = &
        tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1 + tld%owf_fl2b_p123*( &
         - f_vlf(gcc,tld%owf_fwm_p56,tld%owf_fn2_p4))
      tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1 = &
        tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1 + ( &
         + f_fvl(gcc,tld%owf_fl1b_p2,tld%owf_fwm_p56))*tld%owf_fn1_p134
      tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1 = &
        tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1 + ( &
         - f_fvl(gcc,tld%owf_fl2b_p3,tld%owf_fwm_p56))*tld%owf_fn2_p124
      tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1 = &
        tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1 + tld%owf_fu1b_o1_p125*( &
         - f_vlf(gcc,tld%owf_fwp_p34,tld%owf_fd1_i1_p6))
      tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1 = &
        tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1 + ( &
         - f_fvl(gcc,tld%owf_fu1b_o1_p5,tld%owf_fwp_p34))*tld%owf_fd1_i1_p126
      tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1 = &
        tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1 + tld%owf_fa_p12*( &
      ...
      tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1 = &
        tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1 + tld%owf_fz_p12*( &
      ...
      tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1 = &
         - tld%oks_fl1_fl1b_fl2_fn2b_fu1_i1_fd1b_o1 ! 4 vertices, 3 propagators
      ! unit symmetry factor
  end subroutine compute_brakets_0002

end module opr_ww_i1_computation
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! O'Mega API Version 1
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module opr_ww_i1_api_v1
  use opr_ww_i1_computation, only: number_particles_in, number_particles_out, &
       number_color_indices, reset_helicity_selection, new_event, is_allowed, &
       get_amplitude, color_sum, external_masses, openmp_supported, &
       table_coupling_orders, table_coupling_powers, amp_by_orders, &
       table_spin_states, table_flavor_states, number_spin_states, &
...
! NOT FOR PRODUCTION !
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module opr_ww_i1_api_v3
  use omega_birdtracks
  use omega_api_v3
  use opr_ww_i1_computation
  implicit none
  private
