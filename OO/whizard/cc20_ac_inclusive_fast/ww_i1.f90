...
!
!   /cvmfs/sw-nightlies.hsf.org/key4hep/releases/2026-01-31/x86_64-almalinux9-gcc14.2.0-opt/whizard/3.1.5-b77est/bin/omega_SM_ac.opt -o ww_i1.f90 -target:whizard -target:parameter_module parameters_SM_ac -target:module opr_ww_i1 -target:md5sum 84CE608809668E24C61FC5BB8254BA36 -target:openmp -fusion:progress -scatter "e- e+ -> e-:e+ nue:nuebar u:ubar d:dbar"
!
...
!$OMP PARALLEL DO DEFAULT(SHARED) PRIVATE(s, h, tld) SCHEDULE(STATIC)
    do hi = 1, hel_finite
      ...
      amp(1,1,1,h) = tld%oks_fl1_fl1b_fl1b_fn1_fu1b_o1_fd1_i1
      amp(1,2,2,h) = tld%oks_fl1_fl1b_fl1_fn1b_fu1_i1_fd1b_o1
    end do
!$OMP END PARALLEL DO
